        ...
        static void Main(string[] args)
        {
            try
            {
                using (var dbContext = new TestContext())
                {
                    ...
                    var data = (from header in dbContext.RootEntities
                                ...
                                //join aaa in dbContext.AEntities on header.AAAEntityId equals aaa.Id into tempAAA
                                //from aaa in tempAAA.DefaultIfEmpty()
                                //join aaaa in dbContext.AEntities on header.AAAAEntityId equals aaaa.Id into tempAAAA
                                //from aaaa in tempAAAA.DefaultIfEmpty()
                                //join aaaaa in dbContext.AEntities on header.AAAAAEntityId equals aaaaa.Id into tempAAAAA
                                //from aaaaa in tempAAAAA.DefaultIfEmpty()
